...
const Appbar = () => {
  ...
  // Add this style for the new avatar background color
  const customStyles = `
        ...
        <div className="nk-sidebar-element">
          <div className="nk-sidebar-body">
            <SimpleBar className="nk-sidebar-content">
              <div className="nk-sidebar-menu">
                <ul className="nk-menu apps-menu">
                  ...
                  <li
                    className={`nk-menu-item ${
                      currentUrl === process.env.PUBLIC_URL + "/view?page=/account/supporttickets.php" ? "active current-page" : ""
                    }`}
                    id="componentTooltip"
                  >
                    <Link to={`${process.env.PUBLIC_URL}/view?page=/account/supporttickets.php`} className="nk-menu-link">
                      <span className="nk-menu-icon">
              ...
              <div className="nk-sidebar-footer">
                <ul className="nk-menu">
                  ...
                  <li className="nk-menu-item" id="settingsTooltip">
                    <Link to={`${process.env.PUBLIC_URL}/view?page=/account/clientarea.php?action=details`} className="nk-menu-link">
                      <span className="nk-menu-icon">
            ...
            <UncontrolledDropdown className="nk-sidebar-profile nk-sidebar-profile-fixed" direction="right">
              ...
              >
                <UserAvatar text="Hi" theme="purple" className="purple-bg" />
              </DropdownToggle>
              <DropdownMenu end className="dropdown-menu-md ms-4">
                ...
                <div className="dropdown-inner">
                  ...
                  <LinkItem link="/view?page=/account/login" icon="meter" >
                    ...
                    <LinkItem link="/view?page=/account/clientarea.php?action=details" icon="opt">
                      Account Setting
                    </LinkItem>
                    <LinkItem link="/view?page=/account/cart.php?a=view" icon="cart">
                      View My Cart
                    </LinkItem>
                    <LinkItem link="/view?page=/account/clientarea.php?action=emails" icon="list-index">
                      Email History
                    </LinkItem>
                    <LinkItem link="/view?page=/account/clientarea.php?action=security" icon="activity-alt">
                      Account Security
                    </LinkItem>
                    <LinkItem link="/view?page=/account/affiliates.php" icon="briefcase">
                      Affiliate Details
                    </LinkItem>
                    <LinkItem link="/view?page=/account/account/paymentmethods" icon="cc-alt">
                      Payment Methods
                    </LinkItem>
                    <LinkItem link="/view?page=/account/user/password" icon="shield-check">
                    Change Password
                    </LinkItem>
                  </LinkList>
                </div>
                <div className="dropdown-inner">
                  <LinkList>
                    <a href={`${process.env.PUBLIC_URL}/view?page=/account/logout.php`}>
