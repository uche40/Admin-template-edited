      ...
      <Block className="nk-block-middle wide-md mx-auto">
        <BlockContent className="nk-error-ld text-center">
          ...
          <div className="wide-xs mx-auto">
            <h3 className="nk-error-title">Oops! Page Not Found?</h3>
            <p className="nk-error-text">
              We are really very sorry for inconvenience. It looks like you’re try to access a page that either has been
